...
public class MEMParser {
	private static final Logger log = Logger.getLogger(MEMParser.class.getName());
	...
	public static Stats parseLog(InputStream is)
		...
		while (line != null) {
			...
			MEMSample memSample = new MEMSample(time, (double)total,(double)free, (double)available);
